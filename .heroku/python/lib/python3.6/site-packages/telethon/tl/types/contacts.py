...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePeer, TypeImportedContact, TypeContact, TypeTopPeerCategoryPeers, TypeContactLink, TypeChat, TypePopularContact, TypeUser, TypeContactBlocked
    pass
