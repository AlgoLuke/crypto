...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChatFull, TypeMessage, TypeDocument, TypeBotInlineResult, TypeStickerSetCovered, TypeStickerSet, TypeDialog, TypeChat, TypeInlineBotSwitchPM, TypeFoundGif, TypeUser, TypeHighScore, TypeStickerPack, TypeEncryptedFile
